...
const checkIn = function (flightNum, passenger) {
  ...
  if (passenger.passport === 2341234234) {
    alert('Checked in');
  } else {
...
/*
const poll = {
  question: 'What is your favority programming language?',
  ...
  registerNewAnswer: function () {
    ...
    if (typeof userAnswer === 'number' && userAnswer < this.options.length) {
      ...
      //   userAnswer === index && this.answers[index]++;
      // }
      this.answers[userAnswer]++;
    } else {
      console.log('There is no such an option! Try something different!');
    }
...
poll.displayResults.call({ answers: [1, 4, 3, 9, 6, 1] }, 'string');
